...
-- create_company_with_owner moved to 15_team_member_user_search_and_default_departments.sql
-- This file previously had an outdated version without p_departments parameter.
